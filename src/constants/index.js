...
import thenet from "../components/assets/thenet.png"
import kafalat from "../components/assets/kafalat.png"
import kjtech from "../components/assets/kjtech.png"
...
export const skills = [
    ...
    },
    {
        name: "C#",
        image:
            "https://oopy.lazyrockets.com/api/v2/notion/image?src=https%3A%2F%2Fnoticon-static.tammolo.com%2Fdgggcrkxq%2Fimage%2Fupload%2Fv1566916079%2Fnoticon%2Fyqec1z6qsjdf0fsvlh6s.png&blockId=3fa474fc-0b3c-4b8a-ba9d-19a57245e07b&width=256",
    },
    {
        name: "Redux",
        image:
    ...
    {
        name: "C++",
        image: "https://th.bing.com/th/id/OIP.7_ipcB5a2sLEn6Xhn40I8gHaHa?w=500&h=500&rs=1&pid=ImgDetMain",
    },
    {
        name: "MongoDB",
        image:
    ...
    },
    {
        name: "Adobe PS",
        image:
            "https://pngimg.com/uploads/photoshop/photoshop_PNG12.png",
    },
    {
        name: "Figma",
        image:
            "https://image.pngaaa.com/320/5043320-middle.png",
    },
];
...
export const projects = [
    ...
    },
    {
        name: "Threads Clone",
        description:
            "A threads app clone mirrors the core functionalities of Threads, emphasizing seamless communication and organized messaging. Focusing on server side rendering for optimized speed Users can communicate through distinct threads  ",
        tags: [
            {
                name: "react",
                color: "blue-text-gradient",
...
export const education = [
    {
        title: "Masters in Computer Security",
        company_name: "Concordia University",
        icon: concordia,
        iconBg: "#FFFFFF",
        date: "September 2023 - August 2025",
        points: [
            "Fundamental concepts of information security, covering topics like confidentiality, integrity, availability, authentication, and non-repudiation.",
            "security protocols (e.g., SSL/TLS, IPsec) and technologies (e.g., firewalls, intrusion detection/prevention systems) used to secure networks and systems",
            "cryptographic principles, including encryption, decryption, digital signatures, hash functions, and their applications in securing data",
            "assessing security risks, implementing risk management strategies, and developing security policies to mitigate potential threats",
        ],
    },
    {
        title: "Bachelors in Computer Science",
        company_name: "Lebanese American University",
        icon: lau,
        iconBg: "#FFFFFF",
